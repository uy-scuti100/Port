		...
		<div className="max-w-[1680px]">
			<div className="p-[20px] md:p-[100px] ">
				<div>
					...
					<h1
						className={`
                text-${theme.text} pb-10 text-lg font-bold`}
					>
					...
					<div className="md:p-10">
						...
						>
							<ul className="flex flex-col gap-5">
								<li>
									✅ User Profiles: Update personal information, interests, and
									more.
								</li>
								<li>
									✅ User Profiles: Update personal information, interests, and
								...
								<li>
									✅ Content Creation: Craft, edit, and engage with posts and
									comments.
								</li>
								<li>
									✅ Social Connections: Follow users, topics, and bookmark
									posts.
								</li>
								<li>
									✅ Notifications: Receive instant updates on follows and post
									likes.
								</li>
								<li>
									✅ Stunning Visuals: Customize your profile with display and
									banner images.
								</li>
								<li>
									Explore the future of online social interaction and stay
									connected in real time. Try it out today! 🌐
								</li>
							</ul>
							Experience the power of real-time interactivity in my latest
							project. This dynamic social platform combines a wide array of
							features, including:
						</div>
						<Link to="https://react-nexus-nine.vercel.app/" target="_blank">
							<button
								className={`my-5 text-[13px] leading-[16px] font-[roboto] border-b border-brown uppercase ${
									isDarkMode ? "text-[#ffffff]" : "text-[#4A4B65]"
								} font-bold`}
							>
								View Project
							</button>
