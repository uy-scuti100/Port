    ...
    return (
        ...
        >
            ...
            >
                ...
                — a full-stack engineer based in Nigeria. I build
                production-grade systems and ship my own products. Accounting
            ...
            <div
                className={`${
                    isDarkMode ? "text-[#8d8d8dee]" : "text-[#4A4B65]"
                } p-[30px] md:py-[10px] md:px-[50px] text-[18px] about font-bold leading-[1.8] md:ml-28`}
            >
                Find out more{" "}
                <Link to="/about">
